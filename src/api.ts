...
const api = {
  ...
  list: async (): Promise<Restaurant[]> => {
    ...
    const [, ...data] = await fetch('https://docs.google.com/spreadsheets/d/e/2PACX-1vTASP57CHhGPqg9ULdqRWlCLrnspiy4bPiYQKVXMIsGcRFcCu0UBjgbVFciBWy82iTBF5TFFL3QxBRw/pub?output=csv').then(res => res.text()).then(text => text.split('\n'))
